        ...
        try {
            ...
            if (empty($error)) {
                ...
                $stmt = $conn->prepare("UPDATE drivers SET 
                    ...
                    vehicle_model = ?, vehicle_plate = ?, profile_image = ?
                    WHERE id = ?");
                ...
                <div class="profile-card text-center">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span><?php echo number_format($driver['total_trips']); ?></span>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span>تاريخ التسجيل:</span>
                            <span><?php echo date('Y/m/d', strtotime($driver['created_at'])); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="profile-card">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label">البريد الإلكترون�� <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" name="vehicle_plate" value="<?php echo htmlspecialchars($driver['vehicle_plate']); ?>">
                            </div>
